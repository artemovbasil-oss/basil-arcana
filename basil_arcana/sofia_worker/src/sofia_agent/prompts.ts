import type { SofiaAgentTaskRow, SofiaAgentTaskType } from "../db";

function taskGoal(taskType: SofiaAgentTaskType): string {
...
export function buildSofiaTaskPrompt(task: SofiaAgentTaskRow): string {
